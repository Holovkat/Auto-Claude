...
export const AGENTS_MD_PROMPT = `# Task: Analyze this codebase and generate a hierarchical AGENTS.md structure
...
Write AGENTS.md files directly to the project. For each file:
1. Create the file in the appropriate directory
2. Use the exact content generated

Files to create:
1. **Root AGENTS.md** at the project root
2. **Sub-folder AGENTS.md** files for each major package/directory
